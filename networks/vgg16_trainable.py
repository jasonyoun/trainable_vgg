...
class VGG16:
	...
	def __init__(self, num_classes, mean_rgb, vgg16_npy_path=None, init_layers=None, trainable=True, dropout_rate=0.5):
		"""
	...
	def build(self, rgb, train_mode=None):
		...
		log.info('VGG 16 model build started')
		...
		self.pool3 = self.vc.max_pool(self.conv3_3, 'pool3')
		...
		self.pool4 = self.vc.max_pool(self.conv4_3, 'pool4')
		...
		self.pool5 = self.vc.max_pool(self.conv5_3, 'pool5')
		...
		log.info('VGG 16 model build finished')
