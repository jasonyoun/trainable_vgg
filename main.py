	...
	with tf.Session() as sess:
		if mode is 'train':
			...
			solver = Solver(
				...
				network_type='st_vgg',
				log_dir=LOG_DIR,
				weights_path=[os.path.join(WEIGHTS_DIR, 'st_vgg16_cub_ft_localization.npy'),
							  os.path.join(WEIGHTS_DIR, 'st_vgg16_cub_ft_classification.npy')],
				init_layers=[])
